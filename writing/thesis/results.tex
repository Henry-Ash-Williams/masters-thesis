...
\begin{table}[h]
    \centering
    \caption{Performance of our baseline methods for malware detection based on the import tables of executables}
...
\begin{figure}
    ...
    \end{subfigure}
    \caption{Impact of obfuscation on the performance of file and sequence level classification, and certainty of the RoBERTa opcode sequence classification models trained on the obfuscated bengin dataset.}
