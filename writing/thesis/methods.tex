...
\begin{figure}
    ...
    \begin{subfigure}{0.4\textwidth}
        % TODO: Update y label to be code size rather than disk size
...
We also split the dataset into two subsets, a training set used to train our models, and a test set, used during evaluation. The train set consists of 80\% of the full dataset, and the test set consists of the remaining 20\%. 
...
\begin{equation}
    S\left(A,B\right) := \cos\left(\theta\right)=\frac{\mathbf {A} \cdot \mathbf {B}}{\|\mathbf {A} \|\|\mathbf {B} \|}\label{eq:cosine-sim}
\end{equation}
