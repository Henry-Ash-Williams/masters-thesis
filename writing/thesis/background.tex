...
\begin{figure}[h!]
    ...
    \caption{Observed growth in the number of unique instances of malware over time \citep{av-test-theindependentit-securityinstituteAVATLASMalwarePUA2025}.}
