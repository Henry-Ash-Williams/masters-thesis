...
\begin{figure}[h!]
    ...
    \caption{Observed growth in the number of unique instances of malware over time. Data taken from~\citep{av-test-theindependentit-securityinstituteAVATLASMalwarePUA2025}.}
...
Malware is categorised based on its behaviour, and how it spreads between hosts. We present the following taxonomy based on the work of~\cite{manirihoSystematicLiteratureReview2024} shown in~\Cref{fig:malware-taxonomy} that outline the different kinds of malicious behaviors, and propagation techniques. Note that categories within this taxonomy are not mutually exclusive, as malware often belong to multiple categories at once. 
